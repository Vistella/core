...
"""
    ...
    def create_go_button_box(self):
        ...
        self.panel_id = ttk.Entry(master=self.go_button_box, width=9,
                                       textvariable="Panel ID")    
        ...
        self.panel_id_label = ttk.Label(master=self.go_button_box)
        self.panel_id_label["text"] = "Panel ID:"

        # Grid placement in enclosing box
        self.go_button.grid(column=1, row=0)
        self.go_button_status_label.grid(column=0, row=0)
...
class LoopMode(ttk.Checkbutton):
    ...
    def __init__(self, master=None, gui=None, variable=None,
        ...
        # pylint: disable=too-many-arguments
        ttk.Checkbutton.__init__(self, master=master, text="avg(multiple runs)",
